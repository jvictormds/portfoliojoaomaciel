  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        hub: {
          DEFAULT: "hsl(var(--case-hub))",
          foreground: "hsl(var(--case-hub-foreground))",
          soft: "hsl(var(--case-hub-soft))",
          deep: "hsl(var(--case-hub-deep))",
          "deep-foreground": "hsl(var(--case-hub-deep-foreground))",
          accent: "hsl(var(--case-hub-accent))",
        },
