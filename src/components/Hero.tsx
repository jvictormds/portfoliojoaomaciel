          ...
          <div className="space-y-6 animate-fade-in order-2 lg:order-1">
            <div className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
                {highlights.map((highlight, index) => <div key={index} className="text-center p-5 bg-card rounded-lg shadow-medium border-2 border-border/50 hover:border-primary/30 transition-colors">
